...
## Test case: Reject impossible date and accept repeated whitespace

### Aim

Reject February 30, then accept a leap date with multiple spaces between date and time.
...
invalid date format. please use dd-mm-yyyy hhmm (e.g. 17-07-2004 1800).
...
____________________________________________________________
here are the tasks in your list:
1. [d][ ] report (by: 29 Feb 2024, 18:00)
____________________________________________________________
____________________________________________________________
     _          
  __| | ___  ___
...
## Test case: Search preserves numbers and blank search lists all

### Aim

A filtered result keeps task number 2; a whitespace-only search returns both tasks; removal accepts a padded task number.
